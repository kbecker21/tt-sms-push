...
{
	public ClickatellHttp(String myGatewayId, Properties myProps, smscenter.smsserver.SMSServer myServer)
	{
	...
	{
		return getProperties().getProperty(getGatewayId() + "." + "description", "Default Clickatell Gateway");
	}
