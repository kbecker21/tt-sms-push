...
{
	public SerialModem(String myGatewayId, Properties myProps, smscenter.smsserver.SMSServer myServer)
	{
	...
	{
		return getProperties().getProperty(getGatewayId() + "." + "description", "Default Serial Modem Gateway");
	}
