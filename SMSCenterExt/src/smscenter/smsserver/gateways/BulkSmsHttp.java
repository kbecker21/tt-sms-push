...
{
	public BulkSmsHttp(String myGatewayId, Properties myProps, smscenter.smsserver.SMSServer myServer)
	{
	...
	{
		return getProperties().getProperty(getGatewayId() + "." + "description", "Default BulkSms Gateway");
	}
